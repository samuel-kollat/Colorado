...
namespace Colorado.Controllers
{
    public class PortsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,greater_or_equal,less_or_equal")] Port port)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,greater_or_equal,less_or_equal")] Port port)
        {
            if (ModelState.IsValid)
            {
